/**
 * @file /js/views/MechanicalLubricationStandard.js
 * @description “机械润滑”的保养标准视图，增加分页功能。
 * @version 2.0.0 - 2025-10-17
 */
import DataTable from '../components/Optimized_DataTable.js';
import Modal from '../components/Modal.js';

export default class MechanicalLubricationStandard {
    constructor() {
        this.container = null;
        this.dataTable = null;
    ...
    _getMockData() {
        ...
        for (let i = 3; i <= 50; i++) {
            data.push({...data[i % 2], id: i, sbookno: `RH-XXX-润滑-2023-${i}`});
        }
        return data;
    }
    ...
    _renderDataTable(tableContainer) {
        ...
        const tableConfig = {
            columns,
            data: pagedData,
            options: {selectable: 'multiple', storageKey: 'mechLubricationStdTable'}
        };
